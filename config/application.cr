...
Amber::Server.configure do |settings|
  ...
  #
  # settings.name = "Project Ci web application."
  #
  #
  ...
  #
  # settings.secret_key_base= H-CrvQ9nVA4kSRXO46Xlqtyc7J8qvnIv-2ETWH-rYz0
  #
  #
  ...
  #
  # settings.logger = Amber::Environment::Logger.new(File.open("project_ci.log", "w"))
  #
  #
end
